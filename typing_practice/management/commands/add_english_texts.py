    ...
    def handle(self, *args, **options):
        ...
        texts_data = {
            10: [
                ...
                "Creativity flourishes when you embrace new challenges daily.",
                "Networking helps build meaningful professional relationships.",
            ...
            25: [
                ...
                "Cloud computing has revolutionized how businesses store data and run applications, offering scalability and cost efficiency. Companies can now access powerful computing resources without maintaining expensive infrastructure, enabling startups to compete with established enterprises.",
                "Cybersecurity awareness is increasingly important as digital threats evolve constantly. Understanding basic security practices like using strong passwords, enabling two-factor authentication, and recognizing phishing attempts helps protect personal and professional information from malicious actors.",
                "Remote work has become mainstream, offering flexibility and work-life balance benefits. However, it requires strong self-discipline, effective communication tools, and the ability to maintain productivity without direct supervision in traditional office environments.",
            ],
            60: [
                ...
                "Blockchain technology represents a revolutionary approach to data storage and transaction verification that eliminates the need for central authorities. This decentralized system uses cryptographic techniques to create secure, transparent, and immutable records of transactions across distributed networks. While initially developed for cryptocurrencies, blockchain applications now extend to supply chain management, voting systems, and digital identity verification. Understanding blockchain fundamentals helps professionals navigate emerging technologies and identify opportunities in various industries.",
                "Machine learning algorithms enable computers to identify patterns and make predictions from data without explicit programming instructions. These systems improve their performance through experience, becoming more accurate as they process larger datasets. Applications range from recommendation engines that suggest products to medical diagnostic tools that detect diseases. The field combines statistics, computer science, and domain expertise to solve complex problems across industries.",
            ],
            100: [
                ...
                "Artificial intelligence and machine learning technologies are revolutionizing industries across the globe, transforming how businesses operate and how people interact with digital systems. These advanced technologies enable computers to learn from data, recognize patterns, and make intelligent decisions without explicit programming for every scenario. Machine learning algorithms can analyze vast amounts of information in seconds, identifying trends and insights that would take humans weeks or months to discover. From healthcare diagnostics that detect diseases earlier to autonomous vehicles that navigate complex traffic situations, AI applications are becoming increasingly sophisticated and integrated into daily life. The field continues to evolve rapidly, with new breakthroughs in natural language processing, computer vision, and neural networks emerging regularly. As these technologies advance, they create new career opportunities while also raising important questions about ethics, privacy, and the future of work. Understanding AI fundamentals has become valuable knowledge for professionals in many fields, not just computer science.",
                "Climate change represents one of the most pressing challenges facing humanity in the twenty-first century, requiring urgent action from individuals, communities, and governments worldwide. Rising global temperatures, melting ice caps, and extreme weather events are clear indicators that our planet's climate system is undergoing significant changes. The primary driver of these changes is the increased concentration of greenhouse gases in the atmosphere, largely resulting from human activities such as burning fossil fuels, deforestation, and industrial processes. Addressing climate change requires a comprehensive approach that includes transitioning to renewable energy sources, improving energy efficiency, protecting natural ecosystems, and developing innovative technologies that reduce carbon emissions. International cooperation and policy changes are essential for creating meaningful progress, but individual actions also matter significantly. Simple steps like reducing energy consumption, using public transportation, supporting sustainable products, and advocating for environmental policies can collectively make a substantial difference. The transition to a more sustainable future will require creativity, determination, and collaboration across all sectors of society.",
            ]
        }
